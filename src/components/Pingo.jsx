...
const projects=[
    {
        name:'Amazon Clone',
        des:'Amazon Clone is a full-stack e-commerce website that replicates the functionality of the Amazon website. The website allows users to browse products, add them to a shopping cart, and proceed to checkout. The website is built using React for the front end, Node.js and Express for the back end, and MongoDB for the database. The website features a responsive design, user authentication, and a shopping cart system. The website is deployed on Heroku and MongoDB Atlas.',
        image:`${img3}`,
        icons:[next, firebase],
